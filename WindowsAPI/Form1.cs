...
namespace WindowsAPI
{
    public partial class Form1 : Form
    {
        ...
        {
            GetProcesses();
            List<Process> searchprocesses = processes.Where((x) => x.ProcessName.ToLower().Contains(toolStripTextBox1.Text.ToLower())).ToList<Process>();
            RefreshProcessesList(searchprocesses, toolStripTextBox1.Text);
        }
